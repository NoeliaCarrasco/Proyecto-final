        ...
        <div style="width:100%:position:relative;">
          <div class="row" style="width:90%;margin: 0 auto;">
            <div id="">
              ...
              <fieldset>
                <legend><span class="glyphicon glyphicon-user"></span> PRODUCTOS POR CATEGORIAS</legend>
                <?php
                  include("./estadisticaproductoporcategorias.php");
                 ?>
              </fieldset>
            ...
            <div id="">
              ...
              <fieldset >
                ...
                <?php
                  include("./estadisticasproductosmasvendidos.php");
                 ?>
              </fieldset>
